...
// Renders Adsterra banner script inside a container div — avoids mixed content
function AdBannerContainer({ scriptUrl }: { scriptUrl: string }) {
  ...
  return (
    <div
      ref={ref}
      style={{ width: '100%', minHeight: 300, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
    />
  );
}
